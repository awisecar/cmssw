...
def generate(userproxy=''):
    ...
    datasets = {
        ...
        #     'globaltag' : 'auto:run2_data',
        # },
        '/ExpressPhysics/Run2018C-Express-v1/FEVT' : {
            'globaltag' : 'auto:run2_data',
        },
        '/Cosmics/Run2018C-v1/RAW' : {
            'globaltag' : 'auto:run2_data',
        },
    }
    ...
    commandString += 'cd %s/src/RecoLocalMuon/CSCValidation/AutoValidation\n' % CMSSW_BASE
    ...
    for dataset in datasets:
        ...
        acrontabString = '1 3,15 * * * lxplus.cern.ch {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.sh >> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.log 2>> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.err\n'.format(CMSSW_BASE,filename)
        acrontabMergeString = '31 7,19 * * * lxplus.cern.ch {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.sh >> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.log 2>> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.err\n'.format(CMSSW_BASE,mergeFilename)
        crontabString = '1 3,15 * * * {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.sh >> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.log 2>> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.err\n'.format(CMSSW_BASE,filename)
        crontabMergeString = '31 7,19 * * * {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.sh >> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.log 2>> {0}/src/RecoLocalMuon/CSCValidation/AutoValidation/{1}.err\n'.format(CMSSW_BASE,mergeFilename)
